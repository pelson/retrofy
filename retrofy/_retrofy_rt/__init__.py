...
The contents of ``_retrofy_rt/`` are copied verbatim into every converted
package that needs them — by the wheel-build hook
...
``.<pkg>._retrofy_rt.<helper>``, never from ``retrofy.*`` — wheel installs
